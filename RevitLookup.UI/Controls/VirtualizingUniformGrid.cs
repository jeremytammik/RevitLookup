...
/// </summary>
[Obsolete]
public class VirtualizingUniformGrid : Control
{
    /// <summary>
    ...
    /// <summary>
    ///     Compiles all <see cref="VirtualizingUniformGrid" /> items on the code side, puts <see cref="ScrollViewer" /> into <see cref="Content" /> then adds <see cref="ItemsSource" />
    ///     to the <see cref="VirtualizingStackPanel" />.
    /// </summary>
