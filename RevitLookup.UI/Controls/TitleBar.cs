...
public class TitleBar : System.Windows.Controls.Control, IThemeControl
{
    ...
    public override void OnApplyTemplate()
    {
        ...
        var maximizeButton = GetTemplateChild(ElementMaximizeButton) as Button;
        var restoreButton = GetTemplateChild(ElementRestoreButton) as Button;
    ...
    private void InitializeSnapLayout(Button maximizeButton, Button restoreButton)
    {
