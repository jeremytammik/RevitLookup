...
/// </summary>
[TemplatePart(Name = "PART_ScrollViewer", Type = typeof(DynamicScrollViewer))]
[ToolboxItem(true)]
...
public class UiPage : Page
{
    ...
    /// <para>If set, <see cref="DynamicScrollViewer"/> will be added to the <see cref="System.Windows.Controls.Control.Template"/></para>
    /// </summary>
