...
internal sealed class SnapLayout
{
    ...
    {
        return Windows.Is(WindowsRelease.Windows11);
    }
    ...
    private bool IsOverButton(IntPtr wParam, IntPtr lParam)
    {
        try
        {
            var positionX = lParam.ToInt32() & 0xffff;
            var positionY = lParam.ToInt32() >> 16;

            var rect = new Rect(_button.PointToScreen(new Point()),
