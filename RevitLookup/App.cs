...
namespace RevitLookup
{
    public class App : IExternalApplication
    {
        ...
        private static readonly string ExecutingAssemblyPath = Assembly
        ...
        private void AddMenu(UIControlledApplication app)
        {
            ...
            optionsBtn.AddPushButton(new PushButtonData("Snoop Pick Linked Element...", "Snoop Linked Element...", ExecutingAssemblyPath,
                typeof(CmdSnoopModScopeLinkedElement).FullName));
            optionsBtn.AddPushButton(new PushButtonData("Snoop Dependent Elements...", "Snoop Dependent Elements...", ExecutingAssemblyPath,
