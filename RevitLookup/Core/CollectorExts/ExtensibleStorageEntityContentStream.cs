...
using Double = RevitLookup.Core.Data.Double;
using ElementId = Autodesk.Revit.DB.ElementId;
using Enumerable = RevitLookup.Core.Data.Enumerable;
using Exception = System.Exception;
using Object = RevitLookup.Core.Data.Object;
using String = RevitLookup.Core.Data.String;
    ...
    public class ExtensibleStorageEntityContentStream : IElementStream
    {
        ...
        private void AddFieldValue(Field field, object value)
        {
            try
            {
                ...
                {
                    _data.Add(new Data.ElementId(field.FieldName, value as ElementId, _document));
                }
