...
* A brand-new user interface
    ...
    ![изображение](https://user-images.githubusercontent.com/20504884/225030639-f13c5432-84e0-4508-876e-f104794540f5.png)

* Themes support

    ![Screenshot_23](https://user-images.githubusercontent.com/93661926/225276975-44ff4149-3411-4d71-bc3d-8093e6378a0f.png)

* New logo
* Searchbar
* Context menu with new actions

  ![Без имени-6](https://user-images.githubusercontent.com/20504884/225292648-fd485954-f469-4dd4-812d-8a4d8fdf8094.png)

* Tooltips

    ![Screenshot333](https://user-images.githubusercontent.com/93661926/225278782-14624000-5b4a-43ce-9e72-e411fcb17527.png)

* The Snoop Selection button has been moved to the Modify tab

    ![изображение](https://user-images.githubusercontent.com/93661926/225279009-e440f9cd-b59f-4198-b058-e081cc4204c4.png)
...
* Windows 11 snap layouts support
    ...
    ![изображение](https://user-images.githubusercontent.com/93661926/225279198-c6985018-b1fc-435e-9fb4-f0c97f99ff8c.png)
...
* Generic names support
    ...
    | Before                                                                                                                | Now                                                                                                                   |
    |-----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------|
    | ![изображение](https://user-images.githubusercontent.com/20504884/225105646-37f2b052-f3fc-4771-967b-0578a94f9b07.png) | ![изображение](https://user-images.githubusercontent.com/20504884/225105607-ce5b064b-e3b1-4fbe-ab7a-57fe285ab9aa.png) |
...
* Component manager. Now you can explore it from the AdWindows.dll and learn how the ribbon and user interface in Revit are arranged
    ...
    ![Без имени-3](https://user-images.githubusercontent.com/20504884/225289883-c686b3ce-3398-4768-80d3-8ddb229526ac.png)
