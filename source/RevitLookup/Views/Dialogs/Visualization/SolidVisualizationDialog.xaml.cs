...
public sealed partial class SolidVisualizationDialog
{
    ...
    public SolidVisualizationDialog(IServiceProvider serviceProvider, Solid solid)
    {
        var logger = serviceProvider.GetService<ILogger<SolidVisualizationServer>>();
        
        _serviceProvider = serviceProvider;
        _viewModel = new SolidVisualizationViewModel(solid, logger);
